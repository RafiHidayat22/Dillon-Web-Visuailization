  ...
  return (
    <div className="flex flex-wrap justify-center gap-6 p-10 mt-5 bg-gradient-to-r from-[#dbe4f3] via-[#7886C7] to-[#5a6bb2]">
      {cards.map((card, index) => (
        <div
          key={card.title}
          className={`flex flex-col items-center justify-center w-[300px] h-[400px] p-5 rounded-2xl backdrop-blur-xl border-2 border-white/30 bg-white/20 shadow-lg transition-transform duration-300 hover:scale-105 hover:shadow-2xl animate-fadeUp`}
